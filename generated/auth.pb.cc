...
struct RegisterReplyDefaultTypeInternal {
  PROTOBUF_CONSTEXPR RegisterReplyDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 RegisterReplyDefaultTypeInternal _RegisterReply_default_instance_;
}  // namespace auth
...
const uint32_t TableStruct_auth_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::auth::RegisterReply, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::auth::RegisterReply, _impl_.success_),
  PROTOBUF_FIELD_OFFSET(::auth::RegisterReply, _impl_.message_),
};
...
static const ::_pb::Message* const file_default_instances[] = {
  ...
  &::auth::_RegisterReply_default_instance_._instance,
};
...
const char descriptor_table_protodef_auth_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ervice\0220\n\005Login\022\022.auth.LoginRequest\032\023.au"
  "th.LoginResponse\0226\n\010Register\022\025.auth.Regi"
  "sterRequest\032\023.auth.RegisterReplyb\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_auth_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_auth_2eproto = {
    false, false, 360, descriptor_table_protodef_auth_2eproto,
    "auth.proto",
...
RegisterReply::RegisterReply(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:auth.RegisterReply)
}
RegisterReply::RegisterReply(const RegisterReply& from)
  ...
  // @@protoc_insertion_point(copy_constructor:auth.RegisterReply)
}
...
RegisterReply::~RegisterReply() {
  // @@protoc_insertion_point(destructor:auth.RegisterReply)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
// @@protoc_insertion_point(message_clear_start:auth.RegisterReply)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* RegisterReply::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "auth.RegisterReply.message"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* RegisterReply::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:auth.RegisterReply)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:auth.RegisterReply)
  return target;
}

size_t RegisterReply::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:auth.RegisterReply)
  size_t total_size = 0;
...
void RegisterReply::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<RegisterReply*>(&to_msg);
  auto& from = static_cast<const RegisterReply&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:auth.RegisterReply)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:auth.RegisterReply)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::auth::RegisterReply*
Arena::CreateMaybeMessage< ::auth::RegisterReply >(Arena* arena) {
  return Arena::CreateMessageInternal< ::auth::RegisterReply >(arena);
}
